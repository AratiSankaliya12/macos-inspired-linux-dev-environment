...
This folder contains visual evidence of the system design, terminal workflow, and UI customizations implemented in this project.

Screenshots are grouped by purpose to help reviewers quickly understand **what was built** and **why it matters**.

---

## 🖥️ System & UI Customization
